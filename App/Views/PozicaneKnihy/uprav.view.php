    ...
    <div class="row">
        <div class="col-sm-9 col-md-7 col-lg-5 mx-auto">
            <div class="card card-signin my-5">
                <div class="card-body">
                    <h5 class="card-title text-center">Uprav danú knihu</h5>
                    ...
                    <form class="form-signin" method="post" action="<?= $link->url("uprav") ?>">
                        ...
                        <input type="hidden" name="idPozicania" value="<?= htmlspecialchars($pozicanaKnizka->getId()) ?>">

                        <div class="form-label-group mb-3">
                            <label for="id" class="form-label">ID</label>
                            <input name="id" type="number" id="id" class="form-control" readonly
                                   value="<?= htmlspecialchars($pozicanaKnizka->getId()) ?>">
                        </div>
                        ...
                        <div class="form-label-group mb-3">
                            ...
                            <input name="idOriginaluKnizky" type="number" id="idOriginaluKnizky" class="form-control"
                                   value="<?= htmlspecialchars($pozicanaKnizka->getidOriginaluKnizky() ?? '') ?>">
                        </div>
                        ...
                        <div class="form-label-group mb-3">
                            ...
                            <input name="datumPozicania" type="date" id="datumPozicania" class="form-control"
                                   value="<?= htmlspecialchars($pozicanaKnizka->getdatumPozicania() ?? '') ?>">
                        </div>
                        ...
                        <div class="form-label-group mb-3">
                            ...
                            <input name="datumVratenia" type="date" id="datumVratenia" class="form-control"
                                   value="<?= htmlspecialchars($pozicanaKnizka->getdatumVratenia() ?? '') ?>">
                        </div>
                        ...
                        <div class="form-label-group mb-3">
                            ...
                            <input name="dostupna" type="number" id="dostupna" min="0" max="1" class="form-control"
                                   value="<?= htmlspecialchars($pozicanaKnizka->getDostupna() ?? '') ?>">
                        </div>
